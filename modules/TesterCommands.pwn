...
{
	if(isnull(params))
		return SendClientMessage(playerid, COLOR_GREY, "USE: /suporte [texto]");
	...
	SendClientMessage(playerid, COLOR_GREEN, "Solicitação enviada com sucesso aos testers em trabalho!");
