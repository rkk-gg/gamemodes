...
{
	SendClientMessage(playerid, COLOR_GREEN, "___________Animações___________");
	SendClientMessage(playerid, COLOR_WHITE, "/stopanim (/sa)");
	SendClientMessage(playerid, COLOR_STAT2, "/aim /carry /uncarry /taxil /taxir /stretch /flip");
	SendClientMessage(playerid, COLOR_STAT1, "/uncarry /carry /aim /taxil /taxir /roadcross/stretch /flip /slapass /fightstance");
	SendClientMessage(playerid, COLOR_STAT2, "/dance /strip /aimfast/wave /handsup /rifflewalkstance /rifflerunstance /serveglass");
	SendClientMessage(playerid, COLOR_STAT1, "/gsign /dj /camera3 /camera2 /camshot1 /cpr /crawl /dropflag /fixcar /fallkick  ");
	SendClientMessage(playerid, COLOR_STAT2, "/fixcarout /bat /bat2 /batstance /dealerstance /dealerstance2 /dealerstance3 ");
	SendClientMessage(playerid, COLOR_STAT1, "/dunk /dunk2 /dealerstance4 /lean /cry /seduce /comeon /sleep /box1 /box2 /stand");
	SendClientMessage(playerid, COLOR_STAT2, "/crack /crack2 /crack3 /crack4 /stretch2 /throw /fallover /deskbored /tired ");
	SendClientMessage(playerid, COLOR_STAT1, "/rap1 /rap2 /rap3 /fuckyou2 /riot2 /riot3 /shouts /openright /openleft /seat");
	SendClientMessage(playerid, COLOR_STAT2, "/provoke /what /camera1 /baridle /barorder /servebottle /push /payshop /chat");
	SendClientMessage(playerid, COLOR_STAT1, "/idle /crossarm /crossarm3 /crossarm2 /crosswin /rifflestance /lean2 /compready ");
	SendClientMessage(playerid, COLOR_STAT2, "/mourn /old /priest /frontfall /fuckyou /cover /eatanim /exhausted /animtest ");
	SendClientMessage(playerid, COLOR_STAT1, "/kickdoor /lay /laugh /downpush /lowbump /agree /deal /flex /reject /caranim");
	SendClientMessage(playerid, COLOR_STAT2, "/shouldercheck /spray /upshout /washhands /dishes /getupb /shoutat /salute ");
	SendClientMessage(playerid, COLOR_STAT1, "/shout2 /fallhit /forwardlook /sipdrink /sit /sit2 /sit3 /crouchshoot /desksit ");
	SendClientMessage(playerid, COLOR_STAT2, "/crouchreload /aimshoot /aimshoot2 /smokelean /smoke /shotgun /shottyreload");
	SendClientMessage(playerid, COLOR_STAT1, "/blockshot /defense /defenser /dribble /groundhit /hit /kickhim /getshot /dodge ");
	SendClientMessage(playerid, COLOR_STAT2, "/dribble2 /dribble3 /fakeshot /jumpshot /pickupball /angry /stealball /backhit");
	SendClientMessage(playerid, COLOR_STAT1, "/flykick /bitchslap /kungfu1 /kungfu2 /kungfu3 /kungfublock /kungfustomp /choke");
    SendClientMessage(playerid, COLOR_STAT1, "/crushjump /coverdive /coverdive2 /punch /lookout /lookout2 /injured /gotshot");
